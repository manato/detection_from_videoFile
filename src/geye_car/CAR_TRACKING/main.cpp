...
int main(void)
{
  ...
  //  FLOAT thresh = 0.0; //threshold score of detection (default :0.0)
  FLOAT thresh = -0.2; //threshold score of detection (default :0.0)
  FLOAT overlap = 0.4; //threshold overlap parameter (default :0.4)
  //  FLOAT overlap = -0.9;  //threshold overlap parameter (default :0.4)
  //FLOAT overlap = 0.0;  //threshold overlap parameter (default :0.4)
